...
int nvertices = 182; //+ centro +cópia do 1
...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glViewport(0, 0, width, height); //Para os exercicios 4 e 5 é necessario tirar
		...
		//Para os exercicios 4 e 5 é necessario tirar
		glUniform4f(colorLoc, 0.1f, 0.065f, 1.0f, 1.0f);

		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLE_FAN, 0, nvertices);

		glUniform4f(colorLoc, 0.25f, 1.0f, 0.0f, 1.0f);
		glDrawArrays(GL_POINTS, 0, nvertices);
		glBindVertexArray(0);  //até aqui
